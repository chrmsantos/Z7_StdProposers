...
Public Function PreviousFormatting(doc As Document) As Boolean
    ...
    LogStepStart "Quebra de paragrafo antes de sufixo de Vereador"
    BreakParagraphBeforeVereadorSuffix doc
    LogStepComplete "Quebra de paragrafo antes de sufixo de Vereador"
...
Public Sub RestaurarBackup()
    ...
    confirmMsg = "Deseja restaurar o backup mais antigo do documento?" & vbCrLf & vbCrLf & _
                 "[!] ATENCAO: O documento atual sera descartado!" & vbCrLf & _
                 "[!] A restauracao nao podera ser desfeita pelo usuario." & vbCrLf & vbCrLf & _
