    ...
    If hasMonthPattern Then
        ...
        Else
            ...
            If Len(origText) > 0 Then
                ...
                If (firstCharUpper Like "[A-Z0-9�-��]") Or (firstCharUpper = "$") Then
                    IsDataElement = True
                    Exit Function
                End If
            End If
...
Private Sub IdentifyDocumentStructureHeuristics(doc As Document)
    ...
    ' 1. Identifica Titulo, Ementa, Data e Assinatura por regras posicionais dos par�grafos com elementos vis�veis
    ...
    ' Atribui �ndices baseados nas posi��es relativas dos par�grafos vis�veis (T�tulo e Ementa apenas, Assinatura e Data ser�o decididas com base nas novas regras abaixo)
    ...
    ' Os tr�s par�grafos textuais posteriores � data, desde que n�o contenham a palavra "anexo" ou "anexos" (case insensitive), s�o a Assinatura.
    ...
    ' O par�grafo posterior � assinatura que contenha apenas "anexo" ou "anexos" (case insensitive) � o Anexo.
    ...
    For i = 1 To cacheSize
        ...
        With paragraphCache(i)
            ...
            Else
                ...
                ' 4. Identifica DATA (Plenario) - j� foi identificada, mas em caso de loop definimos justificativaEndIndex se i = dataParaIndex
                ElseIf i = dataParaIndex Then
...
' de um requerimento no formato "REQUERIMENTO n� $NUMERO$/$ANO$ � P�gina X" etc.
'================================================================================
...
' de uma indicacao no formato "INDICA��O n� $NUMERO$/$ANO$ � P�gina X" etc.
'--------------------------------------------------------------------------------
...
' de uma mocao no formato "MO��O n� $NUMERO$/$ANO$ � P�gina X" etc.
'--------------------------------------------------------------------------------
