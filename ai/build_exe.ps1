...
function Invoke-PyInstaller {
	...
	$pyiArgs = @($mode, "--noconsole", "--noconfirm",
		"--hidden-import=unicodedata",
		"--hidden-import=openai", "--hidden-import=jiter",
		"--hidden-import=certifi",
		"--hidden-import=pythoncom", "--hidden-import=win32com.client", "--hidden-import=win32com",
		"--collect-all=tkinter",
		$scriptPath)
...
# (desabilitado temporariamente: Word COM trava em hidden window)
